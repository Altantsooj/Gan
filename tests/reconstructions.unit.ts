...
LLLFFFRRRBBB
   ...
   DDD`
	...
	it('custom analyzer solve can be optimized', () => {
		...
		expect(optimized[2][0].solution.toString()).to.equal("r' U' r2 U r' U2 R2 ");
		expect(optimized[2][1].solution.toString()).to.equal("r2 U' r' U r' U2 R2 ");
		...
		expect(optimized[5][0].solution.toString()).to.equal("U2 R2 U' R2 U r2 U M U M U' ");
		expect(optimized[5][1].solution.toString()).to.equal("U2 M2 U r' U2 r U2 r' U' M U' ");
	});
});
